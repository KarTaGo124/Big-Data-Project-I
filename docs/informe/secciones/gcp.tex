...
\textcolor{red}{\textbf{[REVISAR: falta insertar el diagrama de arquitectura definitivo en este punto. Hay una versión pulida pendiente de aprobación del equipo — ver PR \#12 del repositorio. Mientras tanto, la descripción textual de componentes y la justificación técnica de abajo ya cubren el contenido exigido.]}}
