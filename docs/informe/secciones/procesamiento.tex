...
\bottomrule
\end{tabular}
\caption{Cobertura de las 12 consultas por framework: implementadas y ejecutadas con éxito en los 4; el resultado numérico coincide en 11 de las 12 filas (excepción: consulta 11)}
\label{tab:cobertura}
\end{table}
