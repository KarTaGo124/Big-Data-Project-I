...
\textbf{\texttt{wordmedian.txt}}: tabla de frecuencia que relaciona el largo de palabra con la cantidad de palabras de ese largo. La mediana se obtiene acumulando estos conteos, ordenados por largo, hasta llegar al 50\% del total de palabras.
...
Estos tres resultados fueron reproducidos de forma independiente sobre un clúster Dataproc real, obteniendo valores idénticos a los documentados originalmente por el equipo (ver \url{hadoop-mapreduce/README.md}), lo que confirma que el pipeline es completamente reproducible.
