...
Antes de implementar cualquier consulta, se realizó una exploración completa del dataset (ver \texttt{notebooks/exploracion.ipynb}) para entender qué tan ``sucio'' es en la práctica:
