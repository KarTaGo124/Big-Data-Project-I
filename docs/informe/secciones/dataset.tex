...
Los 34{,}335 duplicados de la tabla anterior se calculan sobre el archivo crudo, antes de cualquier limpieza. En el pipeline de las 12 consultas, la deduplicación (consulta 2) corre después de la limpieza inicial (consulta 1), que ya descarta las filas con \texttt{Description} nula o \texttt{Price} $\leq$ 0. Como el conjunto sobre el que se cuentan los duplicados ya es distinto, el número de duplicados eliminados en esa etapa del pipeline es 34{,}147 y no 34{,}335 (ver Sección \ref{sec:operaciones}), ambas cifras son correctas, cada una sobre un conjunto de datos distinto.
