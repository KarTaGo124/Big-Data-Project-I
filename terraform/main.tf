...
# ---------------------------------------------------------------------------
# Cloud NAT: el cluster no tiene IP publica (internal_ip_only = true), asi
# que sin esto no tiene ninguna salida a internet -- ni siquiera para
# "pip install" o "git clone" (los servicios de Google si son alcanzables
# sin esto via Private Google Access, pero PyPI/GitHub no son de Google).
# ---------------------------------------------------------------------------
